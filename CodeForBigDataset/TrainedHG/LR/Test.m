...
%             Temp0(k, :) = sum(Temp0) / (k-1);
            csvwrite("TrainedHG/LR/Result/Portrait1F.csv", Temp1);
            csvwrite("TrainedHG/LR/Result/Portrait2F1.csv", Temp21);
            csvwrite("TrainedHG/LR/Result/Portrait2F2.csv", Temp22);
            csvwrite("TrainedHG/LR/Result/Portrait4F.csv", Temp4);
%             csvwrite("TrainedHG/LR/Result/Portrait29F.csv", Temp0);
            flag = k;
        end
...
%             Temp0(k-flag+1, :) = sum(Temp0) / (k-flag);
            csvwrite("TrainedHG/LR/Result/Landscape1F.csv", Temp1);
            csvwrite("TrainedHG/LR/Result/Landscape2F1.csv", Temp21);
            csvwrite("TrainedHG/LR/Result/Landscape2F2.csv", Temp22);
            csvwrite("TrainedHG/LR/Result/Landscape4F.csv", Temp4);
%             csvwrite("TrainedHG/LR/Result/Landscape29F.csv", Temp0);
        end
    end
end
% 
