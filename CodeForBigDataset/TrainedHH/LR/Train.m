...
for i = 1 : 138
    ...
    if exist(TrainName, 'file')
        ...
        ModelName1 = strcat("TrainedHH/LR/Portrait/Model11F/Model", num2str(i));
        ModelName2 = strcat("TrainedHH/LR/Portrait/Model13F/Model", num2str(i));
        ModelName0 = strcat("TrainedHH/LR/Portrait/Model29F/Model", num2str(i));
...
for i = 139 : 197
    ...
    if exist(TrainName, 'file')
        ...
        ModelName1 = strcat("TrainedHH/LR/Landscape/Model8F/Model", num2str(i));
        ModelName2 = strcat("TrainedHH/LR/Landscape/Model9F/Model", num2str(i));
        ModelName0 = strcat("TrainedHH/LR/Landscape/Model29F/Model", num2str(i));
