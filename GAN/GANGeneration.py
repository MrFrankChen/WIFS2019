...
class GAN():
    ...
    def train(self, userid, numSamples, epochs, batch_size=128, sample_interval=50):
        ...
        name = "Dataset/BigDataset/Converted/Human" + str(userid) + ".npy"
    ...
    def sample_images(self, epoch, userid, numSamples):
        ...
        gen_imgs = np.reshape(gen_imgs, (-1,29))
        Result = pd.DataFrame(gen_imgs)
        name = "Dataset/BigDataset/GanGenerated/Gan" + str(userid) + ".csv"
        Result.to_csv(name)
