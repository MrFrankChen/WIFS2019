...
clf
newheatmap(spreads_small, 1:15, labels_small);
...
clf
newheatmap(spreads_small, [], [], '%0.2f', 'Colormap', 'money', ...
        'Colorbar', true);
...
clf
newheatmap(spreads_small, [], [], '%0.2f', 'TextColor', 'w', ...
...
clf
newheatmap(spreads_small, labels_small, labels_small, '%0.2f', ...
